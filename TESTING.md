...
- Set `TEST_PACKAGE` environment variable: `TEST_PACKAGE=executor pnpm test:cli:integration`

**Specific test by name**
- Set `TEST_NAME` environment variable: `TEST_NAME=TestKeyVault pnpm test:cli:integration`
